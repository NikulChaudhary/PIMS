...
<div id="outermain">
        ...
        <div class="span3">
          ...
          <div class="well sidebar-nav">
			...
			<li ><a href="index.php" >Profile</a></li>
			  <li class='active'><a href="alladmin.php" >All Admin</a></li>
             </ul>
		...
		<div class="span9">
          <div class="hero-unit">
		  <h3>Admins Of System :</h3><hr />
            <a href="#myModal" role="button" class="btn btn-info" data-toggle="modal" style="margin-right:20px;" data-target="#myModal">Add Admin</a><br><br>
		<table cellpadding="1" cellspacing="1" class="table table-hover">
			...
			<?php
			include('../connect.php');
			$result = mysql_query("SELECT * FROM admin ORDER BY adm_id");
					while($row = mysql_fetch_array($result))
						{
							...
							echo '<td><div align="center"><a href="editadminprofile.php?id='.$row['adm_id'].'" title="Click To View Orders">Editprofile</a></div></td>';
							echo '</tr>';
						}
			?>
		</table>
	...
	<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<form name="myForm" action="addadminexec.php" method="post" enctype="multipart/form-data" name="addroom" >
			<div class="modal-body">
	    		 <div class="control-group">
				 	<label class="control-label" for="inputUsername">Username</label>
				    	<div class="controls">
				      		<input type="text" name="adm_username" placeholder="User Name">
				    	</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
				    <label class="control-label" for="inputName">Name</label>
				 	   <div class="controls">
				    	  <input type="text" name="adm_name" placeholder="Name">
				       </div>
				</div>
				<div class="control-group">
				    <label class="control-label" for="inputontact">Contact</label>
				 	   <div class="controls">
				    	  <input type="text" name="adm_contact" placeholder="Contact">
				       </div>
				</div>
				<div class="control-group">
				    <label class="control-label" for="inputEmail">Email</label>
				 	   <div class="controls">
				    	  <input type="email" name="adm_email" placeholder="Email">
				       </div>
				</div>
				<div class="control-group">
				    <label class="control-label" for="inputDesignation">Designation</label>
				 	   <div class="controls">
				    	  <input type="text" name="adm_designation" placeholder="Designation">
				       </div>
				</div>
