...
{
$enno=$_POST["enno"];
$sql="SELECT * FROM student WHERE st_enroll=$enno ";
...
<div id="outermain">
		...
		<table>
		<tr><td>Student Enrollment No.:</td><td>&nbsp;&nbsp;&nbsp;<input type="text" name ="enno" placeholder="Enter Enrollment" style="height: 30px;"/></td>
		</tr>
		
		<tr><td><input type="submit" value="Search" class="btn btn-info"></td></tr>
		</table>
		</form>
		<?php if(isset($_POST["enno"]))
		{
			?>
