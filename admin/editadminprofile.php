...
<div id="outermain">
		...
		<div class="span9">
          <div class="hero-unit">
				...
				<h3 >Edit Profile of Admin:</h3>
								
				<form name="myForm" action="editadminexec.php" method="post" enctype="multipart/form-data" name="addroom">
					<table >
						

						<tr>
						<td>Name</td> 
						<td><input name="adm_name" type="text" value="<?php echo $name;?>" /></td>

						</tr>

						<tr>
						<td>Designation  &nbsp;&nbsp;&nbsp;</td>
						<td><input name="adm_designation" type="text"  value="<?php echo $profession;?>" /></td>
						</tr>

						<tr>
						<td>Email </td>
						<td><input name="adm_email" type="text"  value="<?php echo $mail;?>" /></td>
						</tr>

						<tr>
						<td>Contact</td>
						<td><input name="adm_contact" type="text"  value="<?php echo $con;?>" /></td>
						</tr>
						...
						<tr>
						<td>
						<input type="submit" name="Submit" value="save" class="btn btn-info" /></td><td>
						<a href="alladmin.php"><input value="cancle" class="btn" /></a></td>
						</tr>
						</table>
					</form>
			</div> 
