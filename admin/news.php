                    ...
                    <div class="main container">
                        <nav id="nav-wrap">
                            <ul id="topnav" class="sf-menu">
                                ...
                                <li><a href="student.php">All Users</a></li>
								<li><a href="student.php">Studemt</a></li>
...
<div id="outermain">
          ...
          <div class="well sidebar-nav">
             <ul class="nav nav-list">
			  <li ><a href="allnews" >All News</a></li>
			    <li class='active' ><a href="news.php" >Post news</a></li>
             </ul>
	...
	<div class="span9">
          <div class="hero-unit">
			...
			<tr>
				<td><span style="font-weight:bold;font-size:25px;">Add new update</span></td><td>
			...
			<tr>
				...
				<tr>	<td><strong>Post Title : </strong> </td><td><input type="text" name="ptitle" maxlength="75" /> </td></tr>	
					<tr>		<td><strong>Post detail : </strong></td><td><textarea name="pdetail" rows="10" cols="60"></textarea></td></tr>
					<!-- <tr>		<td><strong>Posted by: </strong></td><td><input type="text" name="postedby" rows="10" cols="60" ></textarea></td></tr> -->
