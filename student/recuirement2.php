...
<div id="outermain">
        ...
        <div class="span3">
          ...
          <div class="well sidebar-nav">
			...
			<li class='active'><a href="recuirement.php" >view project recuirement</a></li>
		...
		<div class="span9">
          <div class="hero-unit">
			...
			<tr>
				<td><span style="font-weight:bold;font-size:25px;">Project Requirement</span></td><td>
						</tr>
			</table>
			</div>
			</div>
			...
			<tr>
				<td>
					...
					<div class="span8" style="float:left;width:100%;">
						
							<?php
							$i=$_GET['id'];
					
							
					$result = mysql_query("SELECT * FROM pro_requirement WHERE prreq_id='$i'");
						...
						while($row = mysql_fetch_array($result))
						  {
							...
							$pro_discipline=$row['pro_discipline'];
							$pro_area=$row['pro_area'];
							$pro_tools=$row['pro_tools'];
							$pro_platform=$row['pro_platform'];
							$pro_expected_time=$row['pro_expected_time'];
							$st=$row['pro_status'];
					...
					?>
						<div class="span8" style="float:left;width:200%;">
					<table class="table">
					
					<tr><th>title : </th><?php echo '<td><div align="left">'.$pro_title.'</div></td>';?></tr>
					<tr><th>description : </th><?php echo '<td><div align="left">'.$pro_desc.'</div></td>';?></tr>
					<tr><th>discipline : </th><?php echo '<td><div align="left">'.$pro_discipline.'</div></td>';?></tr>
					<tr><th>area :</th><?php echo '<td><div align="left">'.$pro_area.'</div></td>';?></tr>
					<tr><th>tools :</th><?php echo '<td><div align="left">'.$pro_tools.'</div></td>';?></tr>
					<tr><th>platform: </th><?php echo '<td><div align="left">'.$pro_platform.'</div></td>';?></tr>
					<tr><th>expected time : </th><?php echo '<td><div align="left">'.$pro_expected_time.'</div></td>';?></tr>
					<tr><th>Project Status : </th><?php echo '<td><div align="left">'.$st.'</div></td>';?></tr>
					...
					<u><h4>Requirement Given By</h4></u>
							<table class="table table-hover">
                                ...
                                <tbody>
									...
									if($ch=="fc")
									{
											$r11 = mysql_query("SELECT f_fname,f_lname,f_designation,f_email,f_mo_no FROM faculty WHERE f_id='$id1'");
								  ...
								  <?php
									...
									$r11 = mysql_query("SELECT * FROM industry_eng_detail WHERE ie_ref_id='$id1'");
