        	...
        	<div class="container">
                ...
                <div class="nav-collapse collapse">
                	<ul class="nav">
						...
						<?php	echo "Welcome &nbsp;".$_SESSION['name']."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"logout.php\" class=\"btn btn-info\">Logout</a>";
						}
						else
						{
						?>	
	    ...
	    <div class="hero-unit">
    	    <fieldset>
    			<legend style="color:#06F; width:450px;">Enter Your Project Information</legend>
					...
					<form name="udp" method="post" action="editpro2.php" onsubmit="return formValidation()">
					...
					<table style="margin-top:20px; margin-left:14px;">
							...
							<tr>
                            	<td> Institute Name <font color="#FF0000"> * &nbsp; &nbsp; </font></td>
                                <td><input class="span3" name="ucname" required="required" placeholder="Enter Email Here" /></td>
                            </tr>  
							
                            <tr>
                            	<td> Address Of College <font color="#FF0000"> *&nbsp; &nbsp;  </font> </td>
                                <td><textarea rows="5" name="uaddr" cols="10" placeholder="Write Industry Address Here"></textarea>                           
                            </tr>
