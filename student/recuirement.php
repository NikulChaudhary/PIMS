			...
			<tr>
				<td>
					...
					<div class="span8" style="float:left;width:100%;">
							...
							<?php
					$q="SELECT prreq_id FROM pro_requirement"; 
				$q=mysql_query($q);
				$j=0;
				...
				while($j>0)
				{			
					$result = mysql_query("SELECT * FROM pro_requirement WHERE prreq_id='$j'");
						...
						while($row = mysql_fetch_array($result))
						  {
							...
							echo "<a href=\"recuirement2.php?id=$j\"><strong>".ucwords($pro_title)."</strong></a></br>";
