...
if(isset($_POST["send"])){
	...
	$mail->SetFrom("nikunjskd20@gmail.com", "Nikunj smtp server"); //From address of the mail
	// put your while loop here like below,
	$mail->Subject = "Your SMTP Mail"; //Subject od your mail
	$mail->AddAddress($email, "nikunjskd@yahoo.com"); //To address who will receive this email
