...
<div id="outermain">
			...
			<div class="span9">
			<div id="heading"><h2 style="color: #2462B5;">Log In to System <?php if(isset($_GET['type']))
			{echo "As $user";
			}?></h2></div>
            ...
            <div class="span8">
				 ...
				 <div class="modal-body">	
				<form name="login_common" method="post" action="login.php" onsubmit="return formValidation()">
				<table cellspacing="4" cellpadding="4" >		
				 <tr>
                    <th><font size="2" color="red">* </font>Username/Email</th>
					<td></td>
                    <td><input type="text" placeholder="Enter Your User ID"  name="uname"></input></td>
                
                </tr>
				<br/>
                  <tr>
                    <th><font size="2" color="red">* </font>Password</th><td></td>
                    <td><input type="password" placeholder="Enter Your Password"  name="pass"></input></td>
		...
		<button class="btn btn-primary" style="width:120px;margin-left:10px;" type="submit">Login</button>
		<button class="btn btn-primary" style="width:120px;margin-left:10px;" type="reset">Reset</button>
		<a href="#myModal" role="button" style="margin-left:10px;" data-toggle="modal"  data-target="#myModal" >Forgot Username/Password???</a>
		<span id="nologin1" style="visibility:hidden;">&nbsp;<font style="color:red;">&nbsp; &nbsp;Wrong Information...........</font></span>
...
{
echo "<script>document.getElementById(\"nologin1\").style.visibility=\"\";;</script>";
}
}
$_SESSION['nologin']=0;
?>
