...
<div id="outermain">
		...
		<div class="span9">
          <div class="hero-unit">
			...
			<?php
					...
					$result = mysql_query("SELECT * FROM faculty where f_id='$id'");
						...
						while($row = mysql_fetch_array($result))
						  {
							...
							$name1=$row['f_fname'];
							$name2=$row['f_lname'];
							$profession=$row['f_designation'];
							$mail=$row['f_email'];
							$clg=$row['f_clgname'];
							$dpt=$row['f_department'];
							$qua=$row['f_qualification'];
							$con=$row['f_mo_no'];
							$dob=$row['f_dob'];
							$doj=$row['f_DOJoin'];
							$gender=$row['f_gender'];
							$expt=$row['f_area_of_expert'];
							$pic=$row['pic'];
						  }
			...
			<tr>
				<td>
					...
					<tr><th>Designation :</th><?php echo '<td><div align="left">'.$profession.'</div></td>';?></tr>
					<tr><th>College : </th><?php echo '<td><div align="left">'.$clg.'</div></td>';?></tr>
					<tr><th>Department: </th><?php echo '<td><div align="left">'.$dpt.'</div></td>';?></tr>
					<tr><th>Qualification : </th><?php echo '<td><div align="left">'.$qua.'</div></td>';?></tr>
					<tr><th>Email : </th><?php echo '<td><div align="left">'.$mail.'</div></td>';?></tr>
					<tr><th>Expertise : </th><?php echo '<td><div align="left">'.$expt.'</div></td>';?></tr>
		...
		<h2>Change Password</h2>	
				...
				<label>New Password</label><input id="p1"  type="password" onchange="check()" required/><br>
				<label>Repeat Password</label><input id="p2" name ="new1" type="password" onchange="check()" required/>
		...
		<div class="span10 pass3" style="display:none;">
			...
			<tr>
				...
				<?php
					...
					<div class="span8" style="float:left;width:80%;">
					<table class="table">
					<tr><th >First Name : </th><td><input name="adm_name1" type="text" value="<?php echo $name1;?>" /></td></tr>
					<tr><th >Last Name : </th><td><input name="adm_name2" type="text" value="<?php echo $name2;?>" /></td></tr>
					...
					<tr><th>Department : </th><td><input name="daprt" type="text"  value="<?php echo $dpt;?>" /></td></tr>
					<tr><th>Qualification : </th><td><input name="qualification" type="text"  value="<?php echo $qua;?>" /></td></tr>
					<tr><th>E-Mail : </th><td><input name="adm_email" type="text"  value="<?php echo $mail;?>" /></td></tr>
					
					<tr><th>Expertise : </th> <td><input name="expt" type="text"  value="<?php echo $expt;?>" /></tr></td>
					<tr><th>Date of Join : </th> <td><input name="doj" type="text"  value="<?php echo $doj?>" /></tr></td>
					<tr><th>Date of Birth : </th> <td><input name="dob" type="text"  value="<?php echo $dob;?>"/></tr></td>
					<tr><th>Gender: </th> <td><input name="gnd" type="text"  value="<?php echo $gender?>"/></tr></td>
					...
					<td><input id="cancle2" type="button" class="btn btn-info" value="CANCLE" /></td></tr>
