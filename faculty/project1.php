...
$year=$_GET['year'];                   //1 
$protitle=$_GET['protitle'];			//1
$protools=$_GET['protools'];			//1
$branch=$_GET['branch'];				//3
...
if($branch!="" && $branch!="SELECT")
{
	...
	$k="AND";
	$q = "SELECT * from student_project_information as A,student as B WHERE A.ref_id=B.st_id ";
	$q = $q.$k." B.st_branch='".$branch."' ";
	$f++;
...
if($protools!="")
{
	if($f)
	$k="AND";
	$q = $q.$k." A.pro_tools_used='".$protools."' ";
	$f++;
}
                    ...
                    <div class="main container">
                        <nav id="nav-wrap">
                            <ul id="topnav" class="sf-menu">
								...
								<li><a href="project.php">Search</a></li>
...
<li ><a href="projectmembersearch.php" >Project Members Search</a></li>
  ...
  <li ><a href="projectsearch.php" >Search</a></li>
		...
		<div class="span9">
          <div class="hero-unit">
		<h3>Resulted Project <a href="project3.php">
					...
					while($row = mysql_fetch_array($r))
						{
							...
							echo '<td><div align="center"><a href="viewprojectprofile.php?id='.$row['pro_id'].'">View Project</a> | <a href="generatepdf.php?id='.$row['pro_id'].'">Print PDF</a> </td>';
							echo '</tr>';
						}
					}
					else{
