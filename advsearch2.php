...
<div id="outermain">
        ...
        <div class="span3">
          <div class="well sidebar-nav">
           ...
           <marquee id="mr"  direction="up"  onmouseover="update()" onmouseout="update1	()">   
			  <ul class="nav nav-list">
           
			  <li class="active"><a href="#">Best project will be given price money worth of 1,000,000 Rs</a></li>
              <li><a href="#">Top 5 project of Computer department</a></li>
              <li><a href="#">Lets be real</a></li>
              <li><a href="#">Seminar for project management held at BVM on 21st jan 2013</a></li>
			  <li><a href="#">Seminar for project management held at BVM on 21st jan 2013</a></li>
			<li><a href="#">Seminar for project management</a></li>
			...
			elseif($max_pages - ($adjacents * 2) > ($start / $per_page) && ($start / $per_page) > ($adjacents * 2))
				{
					...
					echo " <li><a href='advsearch2.php?a=$k&submit=Search+source+code&start=$per_page'>2</a></li> ";
					$i = $start;                 
...
//close to end; only hide early pages
			else
			{
					...
					for ($counter = ($start / $per_page) + 1; $counter <= $max_pages; $counter++)
						{
							if ($i == $start){
								echo " <li><a href='advsearch2.php?search=$search&submit=Search+source+code&start=$i'><b>$counter</b></a></li> ";
									}
							else {
									echo " <li><a href='advsearch2.php?a=$k&submit=Search+source+code&start=$i'>$counter</a></li> ";   
								} 
...
echo " <li><a href='advsearch2.php?a=$k&submit=Search+source+code&start=$next'>Next</a></li> ";    
}   
