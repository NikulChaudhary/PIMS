...
<div id="outermain">
		...
		<div class="span9">
          <div class="hero-unit">
			...
			<tr>
				<td><span style="font-weight:bold;font-size:25px;">Project Undertaken</br></br></br></br></br></span></td><td>
			...
			<tr/>
				...
				<?php 
					$name=$_SESSION['name'];
					//echo $name;
					$re="select * from project_guide_industryperson where ie_ref_id='$name'";
					...
					while($row = mysql_fetch_array($result))
					{
						...
						{
						?>
							<tr><td> <h4><a href ="viewdetail.php?done=1&id=<?php echo $row1['pro_id']; ?>" ><?php echo $row1['pro_title'];?> </a></h4></td></tr>
						<?php
						}
					}
				?>
		...
		<div class="span9">
          <div class="hero-unit">
			...
			<table style="width:100%;">
			<tr>
				<td><span style="font-weight:bold;font-size:25px;">Project Requirement</br></br></br></span></td><td>
			...
			<tr/>
				...
				<?php 
					...
					{
					?>
						<tr><td> <h4><a href ="viewdetail.php?done=2&id=<?php echo $row['prreq_id']; ?>" > <?php echo $row['pro_title'];?> </a></h4></td></tr>
					<?php
					}
					?>
			</table>
