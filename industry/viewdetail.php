		...
		<div class="span10">
          <div class="hero-unit">
			...
			<?php
				...
				if($done == 1)
				{
						$result = mysql_query("SELECT * FROM student_project_information where pro_id='$id'");
			...
			?>
				...
				<td>
					...
					<tr><th>Project Type : </th><?php echo '<td><div align="left">'.$type.'</div></td>';?></tr>
		...
		<div class="span10 pass3" style="display:none;">
			...
			<tr>
				<td>
					...
					<td><a href="viewdetail.php?done=<?php echo $done; ?>&id=<?php echo $id;?>"><input id="cancle" type="button" class="btn" value="CANCLE" /></a></td>
					</tr>
