...
<div id="outermain">
        ...
        <div class="span3">
          ...
          <div class="well sidebar-nav">
			...
			<li ><a href="index.php" >Profile</a></li>
			  ...
			  <li class='active'><a href="projectrequirement1.php" >Project Requirement</a></li>
             </ul>
		  </div><!--/.well -->
        </div><!--/span-->
		...
		<div class="span9">
          <div class="hero-unit">
			...
			<tr>
				<td><span style="font-weight:bold;font-size:25px;">Enter Project Requirement</br></br></br></br></br></span></td><td>
				
			<tr/>
			
			
			
			<form name="req" method="post" action="editreq.php" onsubmit="return formValidation()">
            	<?php
					include('../connect.php');
					$id=$_SESSION['name'];
					...
					<table class="table">
				        	 <tr>
                            	<td> <th >Project Title<th /><font color="#FF0000"> *&nbsp; &nbsp;  </font>  </td>
                                <td><input type="text" name="title" placeholder="Enter Project Title Here" /></td>
                            </tr>
							
                            <tr>
                				<td><th /> Brief Description <th /><font color="#FF0000"> *&nbsp; &nbsp;  </font>  </td>
                                <td><textarea rows="5" name="def" cols="10" placeholder="Write Project Definition Here"></textarea>           
							</tr>
                            <tr>
                            	<td> <th >Project Discipline<th /><font color="#FF0000"> *&nbsp; &nbsp;  </font>  </td>
                                 <td>
								 	<select name="branch">
                            ...
                            <tr>
                            	<td> <th >Area Of Project <th /><font color="#FF0000"> *&nbsp; &nbsp;  </font>  </td>
                                <td><input type="text" name="area" placeholder="Enter Field Here" /></td>
                            </tr>
							
							 <tr>
                            	<td> <th >Tools Used <th /><font color="#FF0000"> *&nbsp; &nbsp;  </font>  </td>
                                <td><input type="text" name="tool" placeholder="Enter Tool Here" /></td>
                            </tr>
							 <tr>
                            	<td><th > Plateform used <th /><font color="#FF0000"> *&nbsp; &nbsp;  </font>  </td>
                                <td><input type="text" name="platform" placeholder="Enter Plateform Here" /></td>
                            </tr>
			                <tr>
                            	<td> <th >Project expected time<th /><font color="#FF0000"> *&nbsp; &nbsp;  </font> </td>
                                <td> <input type="text" name="time" placeholder="time" /></td>                        
                            </tr>
							<tr>
                            	<td> <th />Project Status <th /><font color="#FF0000"> *&nbsp; &nbsp;  </font>  </td>
